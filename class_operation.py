...
class Operation:
    ...
    def __repr__(self):
        """
        через repr делаем вывод полей класса
        :return: возвращаем поля класса
        """
    ...
    def formate_date(self):
        """
        Форматирует дату в заданный вид
        :return: возвращаем дату в заданном формате
        """
    ...
    def mask_from(self):
        ...
        :return: возвращает замаскированный номер
        """
        name = ''
        numbers = ''
        # делаем цикл, чтобы разделить счет карты от номера карты
